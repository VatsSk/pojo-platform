...
public class PublicController {
    ...
    public ResponseEntity<ApiResponse<List<Project>>> getProjects() {
        return ResponseEntity.ok(new ApiResponse<>(true, "Projects fetched", projectRepository.findAll()));
    }

    @GetMapping("/services")
    public ResponseEntity<ApiResponse<List<ServiceItem>>> getServices() {
        return ResponseEntity.ok(new ApiResponse<>(true, "Services fetched", serviceItemRepository.findAll()));
    }
